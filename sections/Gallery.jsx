...
<div className="flex flex-col ">
        ...
        <div className="flex self-center gap-4  mt-4"> 
          <img onMouseOver={(e)=>mouseDown(".image_13")} onMouseLeave={(e)=>mouseOut(".image_13")} className=" object-none image_13" src="/Gallery/pinkfish/gallery_lg_3.png" />
          <img onMouseOver={(e)=>mouseDown(".image_14")} onMouseLeave={(e)=>mouseOut(".image_14")} className=" object-none image_14" src="/Gallery/pinkfish/gallery_lg_4.png" /> 
        </div>
        <div className="flex self-center gap-4  mt-4"> 
          <img onMouseOver={(e)=>mouseDown(".image_15")} onMouseLeave={(e)=>mouseOut(".image_15")} className="object-none image_15" src="/Gallery/pinkfish/gallery_lg_5.png" /> 
        </div>
        <div className="flex self-center gap-4 mt-4 "> 
          <img onMouseOver={(e)=>mouseDown(".image_16")} onMouseLeave={(e)=>mouseOut(".image_16")} className="object-none image_16" src="/Gallery/pinkfish/gallery_lg_6.png" />
          <img onMouseOver={(e)=>mouseDown(".image_17")} onMouseLeave={(e)=>mouseOut(".image_17")} className="object-none image_17" src="/Gallery/pinkfish/gallery_lg_7.png" /> 
        </div>
        <div className="flex self-center gap-4 mt-4 "> 
          <img onMouseOver={(e)=>mouseDown(".image_18")} onMouseLeave={(e)=>mouseOut(".image_18")} className=" object-none image_18" src="/Gallery/pinkfish/gallery_lg_8.png" />
          <img onMouseOver={(e)=>mouseDown(".image_19")} onMouseLeave={(e)=>mouseOut(".image_19")} className="object-none image_19" src="/Gallery/pinkfish/gallery_lg_9.png" /> 
        </div>
        <div className="flex self-center gap-4 mt-4 "> 
          <img onMouseOver={(e)=>mouseDown(".image_20")} onMouseLeave={(e)=>mouseOut(".image_20")} className=" object-none image_20" src="/Gallery/pinkfish/gallery_lg_10.png" />
          <div className="w-3/5 flex flex-col gap-4">
          <img onMouseOver={(e)=>mouseDown(".image_21")} onMouseLeave={(e)=>mouseOut(".image_21")} className="object-none image_21" src="/Gallery/pinkfish/gallery_lg_11.png" /> 
          <img onMouseOver={(e)=>mouseDown(".image_22")} onMouseLeave={(e)=>mouseOut(".image_22")} className="object-none image_22" src="/Gallery/pinkfish/gallery_lg_12.png" /> 
