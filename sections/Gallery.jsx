         ...
         <h1 className="gallery_header text-center  mb-6">Gallery</h1>
               <div id="container" className="flex md:hidden overflow-x-scroll overflow-hidden">
                    <motion.img
                         ...
                         className="w-full object-none" src="/Gallery/pinkfish/gallery_lg_1.png" />
                    <motion.img
                         variants={fadeIn("up", "tween", .1, 1)}
                         initial="hidden"
                         whileInView="show"
                    ...
                    <div className="flex flex-col ">
                         <div className="  flex self-center gap-4 mt-11 ">
                              <motion.div
                                   ...
                                   className="image_11">
                                   <img onClick={() => {setToggler(!toggler), setSlide(1)}} className=" object-none" src="/Gallery/pinkfish/gallery_lg_1.png" />
                              </motion.div>
                              <motion.div
                                   variants={fadeIn("up", "tween", .1, 1)}
                                   initial="hidden"
                                   ...
                                   viewport={{ once: true }}
                                   className="image_11">
                                   <img onClick={() => {setToggler(!toggler), setSlide(2)}} className="object-none image_12 " src="/Gallery/pinkfish/gallery_lg_2.png" />
                              </motion.div>
                         </div>
                         ...
                         <motion.div
                                   ...
                                   viewport={{ once: true }}
                                   className="image_11">
                              <img onClick={() => {setToggler(!toggler), setSlide(3)}} className=" object-none " src="/Gallery/pinkfish/gallery_lg_3.png" />
                                   </motion.div>
                                   <motion.div
                                   variants={fadeIn("up", "tween", .1, 1)}
                                   initial="hidden"
                                   ...
                                   viewport={{ once: true }}
                                   className="image_11">
                              <img onClick={() => {setToggler(!toggler), setSlide(4)}} className=" object-none image_14" src="/Gallery/pinkfish/gallery_lg_4.png" />
                              </motion.div>
                         </div>
                         <motion.div
                         variants={fadeIn("up", "tween", .1, 1)}
